...
(module+ test
  ...
  (define manage1
    (new manage%))
  (define manage1_subs (get-field mbta-subways manage1))
  ...
  ;; ====================================================================================================================================================================
  ;; INTEGRATION_TEST_1: DISABLED List Behavior
  ...
  ;; not really part of Integration_Test_1, but builds on what the test suite was doing by verifying what incorrect inputs trigger different error messages
  (check-equal? '("Brookline Village Station" "Stony Brook Station" "Brookline Hills Station") (get-field disabled manage1))
